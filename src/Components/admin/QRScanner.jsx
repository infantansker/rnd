...
const QRScanner = () => {
  ...
  const sendReminder = async () => {
    ...
    try {
      // This is a placeholder - you would implement actual email/SMS sending here
      console.log('Sending reminder to:', ticketInfo.userEmail);
      ...
      await new Promise((resolve, reject) => {
        setTimeout(() => {
          ...
          if (Math.random() > 0.2) {
            ...
            reject(new Error('Failed to send reminder'));
          }
        }, 1000);
      });
